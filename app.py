    ...
    if eventos and isinstance(eventos, list) and "error" not in eventos:
        ...
        if st.button("⚡ SINCRONIZAR DATOS"):
            ...
            if standings and isinstance(standings, list):
                ...
                # LIMPIEZA PARA FORZAR SINCRONIZACIÓN
...
if st.button("🚀 PROCESAR ANÁLISIS ELITE", use_container_width=True):
    ...
    # RECONSTRUCCIÓN DE POOL DE SUGERENCIAS
    pool = []
...
st.markdown("---")
st.markdown("<p style='text-align: center; color: #555; font-size: 0.8em;'>OR936 Elite v3.2 | Motor Dixon-Coles | Restauración Completa de Mercados</p>", unsafe_allow_html=True)
