...
def analyze_competition_stakes(standings, team_id, league_id):
    # SE AGREGA ID 266 (LIGA PORTUGAL) A LA LISTA DE LIGAS TOP
...
with st.sidebar:
    ...
    ligas_api = {
        ...
        "Liga Portugal Betclic": 266, "Primera División (Argentina)": 128, # <--- SE AGREGA PRIMERA DIVISIÓN DE ARGENTINA
