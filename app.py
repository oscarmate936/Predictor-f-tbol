...
# =================================================================
# 1. CONFIGURACIÓN API & ESTADO (v6.9 - OVER/UNDER PRECISION)
# =================================================================
...
# NUEVOS ESTADOS v6.9 (CONVERSION & TEMPO)
...
# =================================================================
# 2. FUNCIONES DE LÓGICA ELITE (ACTUALIZADAS PARA GOLES)
# =================================================================
...
# =================================================================
st.set_page_config(page_title="OR936 QUANTUM ELITE v6.9", layout="wide")
st.markdown("""
    <style>
...
# =================================================================
with st.sidebar:
    st.markdown("<h2 style='color:#d4af37; text-align:center; font-weight:900;'>GOLD TERMINAL v6.9</h2>", unsafe_allow_html=True)
    ligas_api = {
...
# =================================================================
# 6. CONTENIDO PRINCIPAL (OR936 ELITE v6.9)
# =================================================================
...
st.markdown("<p style='text-align: center; color: #555; letter-spacing: 5px; margin-bottom: 40px;'>PREDICTIVE ENGINE V6.9 QUANTUM + PULSE MODE</p>", unsafe_allow_html=True)
...
if st.button("GENERAR REPORTE DE INTELIGENCIA"):
    ...
    with t7:
        ...
        if st.session_state.get('audit_results'):
            ...
            # (Lógica de validación mantenida sin cambios para estabilidad)
...
st.markdown("<p style='text-align: center; color: #333; font-size: 0.8em; margin-top: 50px;'>OR936 ELITE v6.9 | QUANTUM MONTE CARLO & AUDIT SYSTEM PRO</p>", unsafe_allow_html=True)
